...
(cl:defmethod cl:initialize-instance :after ((m <Obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_ws-msg:<Obstacle> is deprecated: use pepper_ws-msg:Obstacle instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pepper_ws-msg:header-val is deprecated.  Use pepper_ws-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pepper_ws-msg:pose-val is deprecated.  Use pepper_ws-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'primitive-val :lambda-list '(m))
(cl:defmethod primitive-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pepper_ws-msg:primitive-val is deprecated.  Use pepper_ws-msg:primitive instead.")
  (primitive m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Obstacle>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'primitive))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'primitive))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Obstacle>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'primitive) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'primitive)))
    (cl:dotimes (i __ros_arr_len)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Obstacle>)))
  ...
  "3158a8b90aefeef0be9d1fa85396877c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Obstacle)))
  "Returns md5sum for a message object of type 'Obstacle"
  "3158a8b90aefeef0be9d1fa85396877c")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Obstacle>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'primitive) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
