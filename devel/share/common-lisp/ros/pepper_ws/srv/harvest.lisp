...
(cl:defmethod cl:initialize-instance :after ((m <harvest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'harvest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_ws-srv:<harvest-request> is deprecated: use pepper_ws-srv:harvest-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <harvest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'harvest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_ws-srv:<harvest-response> is deprecated: use pepper_ws-srv:harvest-response instead.")))
