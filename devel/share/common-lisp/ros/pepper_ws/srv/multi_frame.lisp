...
(cl:defmethod cl:initialize-instance :after ((m <multi_frame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multi_frame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_ws-srv:<multi_frame-request> is deprecated: use pepper_ws-srv:multi_frame-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <multi_frame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multi_frame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_ws-srv:<multi_frame-response> is deprecated: use pepper_ws-srv:multi_frame-response instead.")))
