...
(cl:defmethod cl:initialize-instance :after ((m <harvest-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'harvest-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name system_ws-srv:<harvest-request> is deprecated: use system_ws-srv:harvest-request instead.")))

(cl:ensure-generic-function 'req_id-val :lambda-list '(m))
(cl:defmethod req_id-val ((m <harvest-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader system_ws-srv:req_id-val is deprecated.  Use system_ws-srv:req_id instead.")
  (req_id m))
...
(cl:defmethod cl:initialize-instance :after ((m <harvest-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'harvest-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name system_ws-srv:<harvest-response> is deprecated: use system_ws-srv:harvest-response instead.")))

(cl:ensure-generic-function 'reply-val :lambda-list '(m))
(cl:defmethod reply-val ((m <harvest-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader system_ws-srv:reply-val is deprecated.  Use system_ws-srv:reply instead.")
  (reply m))
