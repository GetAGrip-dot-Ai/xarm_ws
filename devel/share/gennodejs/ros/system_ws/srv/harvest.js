...
class harvestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type harvestRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type harvestRequest
    let len;
    let data = new harvestRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new harvestRequest(null);
...
class harvestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type harvestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type harvestResponse
    let len;
    let data = new harvestResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new harvestResponse(null);
...
module.exports = {
  ...
  datatype() { return 'system_ws/harvest'; }
};
