...
if("TRUE" STREQUAL "TRUE")
  set(manipulation_SOURCE_PREFIX /home/sridevi/xarm_ws/src/manipulation)
  set(manipulation_DEVEL_PREFIX /home/sridevi/xarm_ws/devel)
  ...
  set(manipulation_INSTALL_PREFIX /home/sridevi/xarm_ws/install)
...
if(NOT "/home/sridevi/xarm_ws/devel/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(manipulation_INCLUDE_DIRS "")
  set(_include_dirs "/home/sridevi/xarm_ws/devel/include;/usr/local/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sridevi/xarm_ws/src/manipulation/${idir}'.  ${_report}")
    endif()
...
set(depends "sawyer_moveit;moveit_visual_tools;moveit_ros_planning_interface;moveit_ros_move_group;move_group_interface;interactive_markers;tf2_geometry_msgs;message_runtime")
